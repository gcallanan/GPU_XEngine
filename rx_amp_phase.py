## \file rx_amp_phase.py
 #
 # \brief A file for plotting the amplitude and phase values of the baselines produced by the GPU X-Engine.  
 #
 # \author Gareth Callanan
 #
 # This file can subscribe to the output of a GPU X-Engine and then plots the amplitude and phase values for a single interpolarisation product of a single antenna pair
